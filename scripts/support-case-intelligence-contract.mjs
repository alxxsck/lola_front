...
const PROJECT_OPERATIONS = [
  ...
  ['CaseIntelligence_saveDetectionDraft', 'project.case_intelligence.detection.manage'],
  ['CaseIntelligence_discardDetectionDraft', 'project.case_intelligence.detection.manage'],
  ['CaseIntelligence_publishDetection', 'project.case_intelligence.release.manage'],
  ...
  ['CaseIntelligence_saveEscalationDraft', 'project.case_intelligence.escalation.manage'],
  ['CaseIntelligence_discardEscalationDraft', 'project.case_intelligence.escalation.manage'],
  ['CaseIntelligence_publishEscalation', 'project.case_intelligence.release.manage'],
  ['CaseIntelligence_saveBudgetDraft', 'project.case_intelligence.release.manage'],
  ['CaseIntelligence_publishBudget', 'project.case_intelligence.release.manage'],
  ...
  ['CaseIntelligence_evaluationDatasets', 'project.case_intelligence.labels.review'],
  ['CaseIntelligence_publishEvaluationDataset', 'project.case_intelligence.labels.review'],
  ['CaseIntelligence_evaluationDataset', 'project.case_intelligence.labels.review'],
  ['CaseIntelligence_evaluationsHistory', 'project.case_intelligence.release.manage'],
  ...
  ['CaseIntelligence_listDecisions', 'project.case_intelligence.decisions.read'],
  ['CaseIntelligence_explainCase', 'project.case_intelligence.decisions.read'],
  ['CaseIntelligence_correctDecision', 'project.case_intelligence.labels.review'],
...
export function validateSupportCaseIntelligenceContract(document) {
  for (const [operationId, permission] of PROJECT_OPERATIONS) {
    requireOperationPermission(contractOperation(document, operationId), permission);
  }
  ...
  for (const permission of [
    ...
    if (!lookupPermissions.has(permission))
      throw new Error(`CaseIntelligence_lookupCommand must publish ${permission}`);
  }

  for (const operationId of STRONG_AUTH_OPERATIONS) {
    if (contractOperation(document, operationId)['x-iam-fresh-strong-authentication'] !== true)
  ...
  requireSchemaPropertyEnum(document, 'CaseIntelligenceEvaluationReportResponseDto', 'status', [
    'PENDING',
    'PROCESSING',
    'OUTCOME_UNKNOWN',
    'PASSED',
  ...
  requireSchemaPropertyEnum(document, 'CaseIntelligenceDetectionRuleDto', 'kind', [
    'EXACT',
    'PHRASE',
    'ATTRIBUTE',
    'SEMANTIC_STATEMENT',
  ...
  requireSchemaFields(document, 'CaseIntelligenceDryRunDto', ['definition', 'messages']);
  ...
  requireSchemaPropertyEnum(document, 'CaseIntelligenceAmbiguousRuleDto', 'action', [
    'OFFER',
    'ASK_REASON_ONCE',
    'ESCALATE',
  ]);
  requireSchemaPropertyEnum(document, 'CaseIntelligenceTrustedOutcomeLimitDto', 'outcome', [
    'NO_ANSWER',
    'KNOWLEDGE_INSUFFICIENT',
    'TOOL_FAILED',
    'UNRESOLVED',
  ]);
  requireSchemaPropertyEnum(document, 'CaseIntelligenceEscalationSimulationStepDto', 'kind', [
  ...
  const routerContext = contractSchema(document, 'CaseIntelligenceRouterContextDto');
  ...
  const detectionPolicy = contractSchema(document, 'CaseIntelligenceDetectionPolicyDto');
  ...
  requireSchemaPropertyEnum(document, 'CaseIntelligenceDetectionRuleDto', 'action', [
    'NO_CASE',
    'CREATE',
    'ATTACH',
    'REOPEN',
  ...
  requireSchemaPropertyEnum(document, 'CaseIntelligenceDryRunResponseDto', 'caseDecision', [
    'NO_CASE',
    'CREATE',
    'ATTACH',
    'REOPEN',

...
test('Case creation and later escalation remain two independent generic deliveries', async () => {
  ...
  assert.doesNotMatch(JSON.stringify(runtime.notifications), /must-not-be-rendered/u);
  assert.notEqual(runtime.notifications[0].options.tag, runtime.notifications[1].options.tag);
});

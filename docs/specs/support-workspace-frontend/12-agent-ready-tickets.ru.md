...
| 32  | JSM/HelpDesk actions в Case inspector — frontend complete | 16, 30, 31 + backend `4a96a2a7`  | [Открыть](../../../.scratch/support-workspace/issues/32-add-case-external-work-actions.md)               |

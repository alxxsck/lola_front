 ...
 */
import type { TranslationUsageSurfaceBreakdownResponseDtoSurface } from "./translationUsageSurfaceBreakdownResponseDtoSurface";

export interface TranslationUsageSurfaceBreakdownResponseDto {
  /** @nullable */
  ...
  requests: number;
  successes: number;
  surface: TranslationUsageSurfaceBreakdownResponseDtoSurface;
  totalTokens: number;
}

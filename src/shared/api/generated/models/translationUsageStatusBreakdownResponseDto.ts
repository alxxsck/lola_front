 ...
 */
import type { TranslationUsageStatusBreakdownResponseDtoStatus } from "./translationUsageStatusBreakdownResponseDtoStatus";

export interface TranslationUsageStatusBreakdownResponseDto {
  /** @nullable */
  ...
  requests: number;
  status: TranslationUsageStatusBreakdownResponseDtoStatus;
  successes: number;
  totalTokens: number;
}

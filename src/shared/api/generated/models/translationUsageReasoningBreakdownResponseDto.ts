 ...
 */
import type { TranslationUsageReasoningBreakdownResponseDtoReasoningEffort } from "./translationUsageReasoningBreakdownResponseDtoReasoningEffort";

export interface TranslationUsageReasoningBreakdownResponseDto {
  requests: number;
  successes: number;
  ...
  isOther: boolean;
  reasoningEffort: TranslationUsageReasoningBreakdownResponseDtoReasoningEffort;
}

...
<style scoped>
.schema-fields{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:13px}.field-wide{grid-column:1/-1}.required{color:#e26058}.field-hint{color:var(--muted);font-size:.68rem}.field-error{color:#c44747;font-size:.7rem}.select-option{display:flex;align-items:center;justify-content:space-between;gap:16px;width:100%}.select-option small{color:var(--muted);font-size:.65rem}.no-config{padding:12px 14px;border-radius:11px;background:#f4f6ed;color:#626858;font-size:.79rem}.no-config i{color:#75a536;margin-right:6px}.variable-pills{display:flex;flex-wrap:wrap;gap:5px}.variable-pills button{border:1px solid #dddfe6;background:#f7f6ff;color:#6753c6;border-radius:7px;padding:4px 7px;font:500 .62rem ui-monospace,SFMono-Regular,Menlo,monospace;cursor:pointer}.variable-pills button:hover{background:#ece8ff;border-color:#cfc6fb}@media(max-width:680px){.schema-fields{grid-template-columns:1fr}.field-wide{grid-column:auto}}
</style>

...
export const projectMembershipApi = {
  ...
  get: (projectId: string, membershipId: string) => projectMembershipGet(projectId, membershipId),
  create: (projectId: string, body: CreateProjectMembershipDto) =>
    projectMembershipCreate(projectId, {
      ...body,
      reason: reason(body.reason),
    }),
  update: (projectId: string, membershipId: string, body: UpdateProjectMembershipDto) =>
    projectMembershipUpdate(projectId, membershipId, {
      ...body,
      reason: reason(body.reason),
    }),
  remove: (projectId: string, membershipId: string, body: RemoveProjectMembershipDto) =>

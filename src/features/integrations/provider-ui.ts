...
export type OutboundProviderUi = {
  ...
  rotateInput: (expectedVersion: number, secret: string) => ProviderRotateCredentialInput;
...
export const outboundProviderUi: Record<OutboundIntegrationProvider, OutboundProviderUi> = {
  AMPLITUDE: {
    id: 'AMPLITUDE',
    slug: 'amplitude',
    title: 'Amplitude',
    ...
    connectionMutationError: 'Не удалось изменить подключение Amplitude. Повторите попытку.',
    connectionUpdated: 'Настройки Amplitude обновлены.',
    connectionTestSucceeded: 'Amplitude приняла тестовое событие. Подключение можно активировать.',
    ...
    createRoute: (projectId, input, idempotencyKey) =>
      integrationEventRoutesApi.createAmplitude(projectId, input, idempotencyKey),
  },
  CUSTOMER_IO: {
    id: 'CUSTOMER_IO',
    slug: 'customer-io',
    ...
    connectionMutationError: 'Не удалось изменить подключение Customer.io. Повторите попытку.',
    ...
    createRoute: (projectId, input, idempotencyKey) =>
      integrationEventRoutesApi.createCustomerIo(projectId, input, idempotencyKey),
  },
};

...
<style scoped>
.rule-builder{container:rule-builder / inline-size;display:flex;flex-direction:column;gap:14px;min-width:0;padding:20px;background:#f5f6f1;color:var(--ink)}.builder-header{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.builder-header h2{font-size:1.1rem}.builder-header p{margin:5px 0 0;color:var(--muted);font-size:.72rem}.health{flex:0 0 auto;padding:9px 11px;border:1px solid #dfe2d8;border-radius:12px;background:#fff;text-align:right}.health strong,.health span{display:block}.health strong{font-size:.71rem}.health span{margin-top:3px;color:var(--muted);font-size:.62rem}.health.valid{border-color:#c8dfad;background:#f7fbea}.health.invalid{border-color:#edc5bd;background:#fff8f6}.recipe-panel{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:13px 14px;border:1px solid #dedbec;border-radius:14px;background:#fbfaff}.recipe-panel h3{margin:2px 0 0;font-size:.78rem}.recipe-panel p{margin:4px 0 0;color:var(--muted);font-size:.64rem}.recipe-actions{display:flex;gap:7px}.recipe-actions button{padding:8px 10px;border:1px solid #d6d0ef;border-radius:10px;background:#fff;color:#604db9;font-size:.65rem;font-weight:700;cursor:pointer}.recipe-actions button:disabled{opacity:.45;cursor:not-allowed}.glossary{padding:0 3px;color:#666b62;font-size:.67rem}.glossary summary{cursor:pointer;font-weight:700}.glossary dl{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:9px 0 0}.glossary dl div{padding:9px;border-radius:10px;background:#fff}.glossary dt{font-weight:800}.glossary dd{margin:3px 0 0;line-height:1.4}.rule-tree{margin:0;padding:0}.builder-summary{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:14px;padding:14px;border:1px solid #dde0d7;border-radius:15px;background:#242821;color:#f3f4ef}.builder-summary>div>span{display:block;color:#aeb3a8;font-size:.61rem;text-transform:uppercase;letter-spacing:.08em}.builder-summary>div>strong{display:block;margin-top:5px;font-size:.72rem;line-height:1.45}.builder-summary dl{display:flex;gap:14px;margin:0}.builder-summary dl div{text-align:right}.builder-summary dt{color:#9fa59a;font-size:.58rem}.builder-summary dd{margin:3px 0 0;font-size:.7rem;font-weight:700}.builder-summary details{grid-column:1/3;color:#bdc1b8;font-size:.63rem}.builder-summary details summary{cursor:pointer}.builder-summary details p{margin:7px 0 0}.builder-summary code{color:#d7ff64}.sr-live{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}

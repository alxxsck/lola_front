...
<style scoped>
.source-picker{margin:14px 0;padding:16px;border:1px solid var(--border-default);border-radius:16px;background:var(--surface-card);box-shadow:var(--shadow-raised)}header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}header small{color:var(--text-small-muted);font-size:.64rem;text-transform:uppercase;letter-spacing:.1em}h3{margin:3px 0 0;font-size:.92rem}.icon-button{display:grid;place-items:center;width:36px;height:36px;border:0;border-radius:10px;background:transparent;color:var(--text-small-muted);cursor:pointer}.source-list{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;margin-top:14px}.source-list button{display:grid;grid-template-columns:34px minmax(0,1fr) 16px;align-items:center;gap:9px;min-width:0;padding:12px;border:1px solid var(--line);border-radius:13px;background:var(--surface-subtle);color:var(--ink);text-align:left;cursor:pointer}.source-list button:hover{border-color:var(--status-violet);background:var(--status-violet-soft)}.source-list button:disabled{opacity:.5;cursor:not-allowed}.source-list button:disabled:hover{border-color:var(--line);background:var(--surface-subtle)}.source-list button>i:first-child{display:grid;place-items:center;width:34px;height:34px;border-radius:10px;background:var(--status-violet-soft);color:var(--status-violet-text)}.source-list button>i:last-child{font-size:.65rem;color:var(--text-secondary)}.source-list strong,.source-list small{display:block}.source-list strong{font-size:.75rem}.source-list small{margin-top:3px;color:var(--text-small-muted);font-size:.64rem;line-height:1.35}@container rule-builder (max-width:768px){.source-list{grid-template-columns:1fr}}@container rule-builder (max-width:390px){.source-picker{padding:12px}.source-list button{padding:10px}}@container rule-builder (max-width:320px){.source-picker{margin-inline:0}.source-list button{grid-template-columns:30px minmax(0,1fr) 12px}}
</style>

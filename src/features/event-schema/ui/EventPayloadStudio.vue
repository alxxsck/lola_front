...
<style scoped>
.payload-studio{display:flex;min-width:0;flex-direction:column;gap:16px}.studio-header,.field-main,.field-meta,.opaque-field,.sample-validator>header{display:flex;align-items:center;justify-content:space-between;gap:12px}.studio-header strong,.studio-header span,.opaque-field strong,.opaque-field span,.sample-validator header strong,.sample-validator header span{display:block}.studio-header span,.opaque-field span,.sample-validator header span{margin-top:4px;color:var(--muted);font-size:.76rem;line-height:1.45}.secondary-button,.primary-inline-button,.link-button,.icon-button{border:0;cursor:pointer;font:inherit}.secondary-button,.primary-inline-button{padding:9px 12px;border-radius:8px;font-size:.76rem;font-weight:700}.secondary-button{background:#efedf9;color:#5f49c8}.primary-inline-button{background:#6653c5;color:#fff}.link-button{padding:3px 0;background:transparent;color:#6653c5;font-size:.76rem}.icon-button{width:36px;height:36px;border-radius:50%;background:transparent;color:#b24938;font-size:1.2rem}.schema-fields{display:flex;flex-direction:column;gap:10px}.schema-field{padding:14px;border:1px solid var(--line);border-radius:12px;background:#fff}.schema-field.unsupported{background:#fbf8ef}.field-main{display:grid;grid-template-columns:1.15fr 1fr .78fr 120px 36px;align-items:end}.field-main label,.field-details label{display:flex;flex-direction:column;gap:6px;color:#61665d;font-size:.74rem;line-height:1.35}.field-main input,.field-main select,.field-details input,.field-details select,.field-details textarea,.advanced-editor textarea,.sample-validator textarea{box-sizing:border-box;width:100%;border:1px solid #d7d9d2;border-radius:8px;background:#fff;padding:9px 10px;color:var(--ink);font:inherit}.field-main small,.field-details small,.technical-identity small{color:var(--muted);font-size:.7rem;line-height:1.4}.checkbox-label{display:flex!important;flex-direction:row!important;align-items:center!important;gap:8px!important;color:#51564e!important;font-size:.76rem!important}.checkbox-label input{width:auto}.field-meta{margin-top:10px;color:#856241;font-size:.74rem}.field-meta .available{color:#2f7b3c}.field-details{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:13px;margin-top:13px;padding-top:13px;border-top:1px solid var(--line)}.field-details .wide{grid-column:span 2}.readonly-note,.technical-identity{padding:10px;border-radius:8px;background:#f7f7f3;color:var(--muted);font-size:.74rem}.technical-identity{display:flex;flex-direction:column;gap:4px}.technical-identity code{overflow-wrap:anywhere;color:#555b51}.constraint-warning{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px;border-radius:8px;background:#fff2dc;color:#7c561d;font-size:.74rem}.no-fields,.schema-options{padding:13px;border-radius:9px;background:#f7f7f3;color:var(--muted);font-size:.76rem}.schema-diff{padding:15px;border:1px solid #eadfc1;border-radius:11px;background:#fffaf0}.schema-diff strong{font-size:.82rem}.schema-diff p,.schema-diff li{color:#666b62;font-size:.76rem;line-height:1.45}.schema-diff ul{margin:9px 0 0;padding-left:20px}.no-changes{margin-bottom:0}.sample-validator{display:flex;min-width:0;flex-direction:column;align-items:stretch;gap:11px;padding:15px;border:1px solid var(--line);border-radius:11px;background:#fff}.sample-validator pre{box-sizing:border-box;width:100%;max-height:180px;margin:0;padding:12px;overflow:auto;border-radius:8px;background:#252821;color:#dce7c1;font-size:.74rem;line-height:1.5}.sample-details{padding:11px 12px;border-radius:9px;background:#f7f7f3}.sample-details summary{cursor:pointer;color:#5f49c8;font-size:.76rem;font-weight:700}.sample-details summary span{color:var(--muted);font-weight:400}.sample-details p{color:var(--muted);font-size:.74rem;line-height:1.45}.sample-details textarea{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.74rem;line-height:1.5;resize:vertical}.sample-details .secondary-button{margin-top:9px}.sample-success{margin:0;color:#2f763b;font-size:.76rem}.sample-issues{width:100%;table-layout:fixed;border-collapse:collapse;font-size:.74rem}.sample-issues th,.sample-issues td{padding:9px;border-top:1px solid var(--line);overflow-wrap:anywhere;text-align:left;vertical-align:top}.advanced-schema{border-top:1px solid var(--line);padding-top:13px}.advanced-editor{display:flex;flex-direction:column;align-items:stretch;gap:11px;margin-top:10px}.advanced-editor p{margin:0;color:var(--muted);font-size:.74rem;line-height:1.45}.advanced-editor textarea{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.74rem;line-height:1.5;resize:vertical}.advanced-review{display:flex;flex-direction:column;gap:5px;padding:11px;border-radius:9px;background:#eef7ed;color:#35633b;font-size:.76rem}.advanced-review ul{margin:4px 0 0;padding-left:19px}.advanced-actions{display:flex;gap:9px;flex-wrap:wrap}.schema-error{margin:8px 0 0;color:#a93425;font-size:.76rem;line-height:1.4}

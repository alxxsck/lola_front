...
describe('Project Actions store', () => {
  ...
  it('deduplicates concurrent authoritative catalog loads by project', async () => {
    ...
    vi.mocked(projectActionsRepository.listProjectActions).mockReturnValue(
      new Promise((resolve) => {
  ...
  it('does not repopulate preview or mutation state after session teardown', async () => {
    ...
    vi.mocked(projectActionsRepository.preview).mockReturnValue(
      new Promise((resolve) => {
        resolvePreview = resolve;
      }),
    );
    vi.mocked(projectActionsRepository.configure).mockReturnValue(
      new Promise((resolve) => {

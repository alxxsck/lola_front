...
const FORBIDDEN_FIELD =
  /(?:^|[_-])(handler|command|method|url|uri|token|secret|script|selector|route|modalname)(?:$|[_-])/i;

export function buildProjectActionForm(
  schemaValue: unknown,
...
export function validateProjectActionConfiguration(
  ...
  for (const field of form.fields) {
    const present =
      Object.prototype.hasOwnProperty.call(configuration, field.key) &&
...
function numberBounds<T extends readonly string[]>(

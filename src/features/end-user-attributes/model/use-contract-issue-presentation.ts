...
import { presentContractIssues, type ContractIssueInput } from './contract-issue-presentation';
...
export function useContractIssuePresentation(
  ...
  const presentedIssues = computed(() => presentContractIssues(toValue(issues), toValue(fields)));

...
<style scoped>
.audience-builder{container:audience-builder / inline-size;display:flex;flex-direction:column;gap:14px;min-width:0;padding:20px;background:var(--surface-subtle);color:var(--ink)}.builder-header{display:flex;align-items:flex-start;justify-content:space-between;gap:18px}.builder-header h2{font-size:1.1rem}.builder-header p{margin:5px 0 0;color:var(--text-small-muted);font-size:.72rem}.health{flex:0 0 auto;padding:9px 11px;border:1px solid var(--border-default);border-radius:12px;background:var(--surface-card);text-align:right}.health strong,.health span{display:block}.health strong{font-size:.71rem}.health span{margin-top:3px;color:var(--text-small-muted);font-size:.62rem}.health.ready{border-color:var(--status-success);background:var(--status-success-soft)}.health.invalid,.health.unsupported{border-color:var(--status-danger);background:var(--status-danger-soft)}.semantics-note{display:flex;gap:10px;padding:12px 14px;border:1px solid var(--status-violet);border-radius:13px;background:var(--status-violet-soft);color:var(--status-violet-text)}.semantics-note strong,.semantics-note span{display:block}.semantics-note strong{font-size:.7rem}.semantics-note span{margin-top:3px;font-size:.64rem;line-height:1.4}.policy{padding:0 3px;color:var(--text-secondary);font-size:.67rem}.policy summary{cursor:pointer;font-weight:800}.policy p{margin:7px 0 0;line-height:1.5}.audience-tree{margin:0;padding:0}.summary{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;padding:14px;border-radius:15px;background:var(--surface-emphasis);color:var(--text-on-emphasis)}.summary span{display:block;color:var(--text-on-emphasis-muted);font-size:.58rem;text-transform:uppercase}.summary strong{display:block;margin-top:4px;font-size:.7rem;line-height:1.45}.summary dl{display:flex;gap:14px;margin:0}.summary dl div{text-align:right}.summary dt{color:var(--text-on-emphasis-muted);font-size:.57rem}.summary dd{margin:3px 0 0;font-size:.7rem;font-weight:800}.summary small{grid-column:1/3;color:var(--text-on-emphasis-muted);font-size:.6rem}.summary code{color:var(--brand)}.source-backdrop{position:fixed;inset:0;z-index:1190;display:grid;background:var(--overlay-backdrop);place-items:center;padding:18px}.source-picker{width:min(620px,100%);padding:20px;border-radius:18px;background:var(--surface-card);box-shadow:var(--shadow-dialog)}.source-picker header{display:flex;justify-content:space-between}.source-picker header span{color:var(--status-violet-text);font-size:.58rem;font-weight:800;text-transform:uppercase}.source-picker h3{margin:3px 0 0}.source-picker p{margin:3px 0 0;color:var(--text-small-muted);font-size:.64rem}.source-picker header button{width:32px;height:32px;border:0;border-radius:50%;background:var(--surface-subtle)}.source-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:16px}.source-grid>button{display:flex;align-items:center;gap:10px;padding:13px;border:1px solid var(--border-default);border-radius:12px;background:var(--surface-card);text-align:left;cursor:pointer}.source-grid>button:hover{border-color:var(--status-violet-text);background:var(--status-violet-soft)}.source-grid i{color:var(--status-violet-text)}.source-grid strong,.source-grid small{display:block}.source-grid strong{font-size:.7rem}.source-grid small{margin-top:3px;color:var(--text-small-muted);font-size:.6rem;line-height:1.35}@container audience-builder (max-width:520px){.audience-builder{padding:13px}.builder-header{flex-direction:column}.summary{grid-template-columns:1fr}.summary dl{justify-content:space-between}.summary small{grid-column:1}.source-grid{grid-template-columns:1fr}}
</style>

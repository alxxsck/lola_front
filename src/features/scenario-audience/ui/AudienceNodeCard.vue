...
<style scoped>
.audience-node{list-style:none;margin:0;padding:0}.group-card,.leaf-card,.not-card{border:1px solid var(--border-default);border-radius:14px;background:var(--surface-card)}.group-card{padding:12px}.group-card>header{display:flex;align-items:flex-end;justify-content:space-between;gap:10px}.group-card label{display:flex;flex-direction:column;gap:5px}.group-card label span{color:var(--text-small-muted);font-size:.58rem;text-transform:uppercase}.group-card select{padding:7px 9px;border:1px solid var(--border-default);border-radius:8px;background:var(--surface-card);font-size:.7rem;font-weight:800}.group-card ol,.not-card ol{display:flex;flex-direction:column;gap:8px;margin:10px 0 0;padding:0 0 0 14px;border-left:2px solid var(--status-violet-soft)}.group-card footer{display:flex;gap:7px;margin-top:10px}.group-card button,.leaf-card button,.not-card button{border:1px solid var(--border-default);border-radius:8px;background:var(--surface-card);color:var(--text-secondary);cursor:pointer}.group-card>header>button,.leaf-card button,.not-card header button{width:32px;height:32px}.group-card footer button{padding:7px 10px;font-size:.64rem;font-weight:800}.group-card button:disabled{opacity:.4}.empty{margin:10px 0 0;padding:12px;border-radius:10px;background:var(--surface-subtle);color:var(--text-small-muted);font-size:.65rem}.leaf-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:10px;padding:11px}.leaf-icon{display:grid;width:34px;height:34px;border-radius:10px;background:var(--status-violet-soft);color:var(--status-violet-text);place-items:center}.leaf-card span,.leaf-card strong{display:block}.leaf-card span{color:var(--text-small-muted);font-size:.57rem;text-transform:uppercase}.leaf-card strong{margin-top:3px;font-size:.68rem;line-height:1.4}.leaf-actions{display:flex;gap:5px}.not-card{padding:10px;border-color:var(--status-danger);background:var(--status-danger-soft)}.not-card>header{display:grid;grid-template-columns:auto minmax(0,1fr) auto auto;align-items:center;gap:7px}.not-card strong,.not-card small{display:block}.not-card strong{font-size:.66rem}.not-card small{margin-top:2px;color:var(--text-small-muted);font-size:.58rem}.not-badge{padding:5px 7px;border-radius:7px;background:var(--status-danger-text);color:var(--on-status-danger);font-size:.61rem;font-weight:900}@media(max-width:520px){.leaf-card{grid-template-columns:auto 1fr}.leaf-actions{grid-column:1/3;justify-content:flex-end}.group-card ol,.not-card ol{padding-left:8px}}

...
<style scoped>
.leaf-backdrop{position:fixed;inset:0;z-index:1200;background:#20241f66}.leaf-editor{position:absolute;top:0;right:0;display:flex;flex-direction:column;gap:16px;width:min(520px,100%);height:100%;padding:24px;background:#fff;box-shadow:-18px 0 50px #20241f22;overflow:auto}.leaf-editor header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.leaf-editor header span{color:#7764d2;font-size:.62rem;font-weight:800;text-transform:uppercase;letter-spacing:.08em}.leaf-editor h3{margin:4px 0 0;font-size:1.25rem}.leaf-editor header button{width:34px;height:34px;border:0;border-radius:50%;background:#f1f2ed;cursor:pointer}.intro{margin:0;color:var(--muted);font-size:.75rem;line-height:1.55}.field{display:flex;flex-direction:column;gap:7px}.field>span{font-size:.7rem;font-weight:800}.field select,.field input{width:100%;min-height:42px;padding:9px 11px;border:1px solid #d9ddd3;border-radius:10px;background:#fff;font:inherit}.field [aria-invalid=true]{border-color:#d75e4d;box-shadow:0 0 0 3px #d75e4d14}.field small{color:var(--muted);font-size:.64rem;line-height:1.45}.active-issue{padding:10px 12px;border:1px solid #efb7ad;border-radius:10px;background:#fff5f3;color:#9a3023;font-size:.7rem}.privacy-note{display:flex;gap:10px;padding:12px;border:1px solid #e5dcae;border-radius:12px;background:#fffcee;color:#665d2c}.privacy-note strong,.privacy-note span{display:block}.privacy-note strong{font-size:.7rem}.privacy-note span{margin-top:3px;font-size:.64rem;line-height:1.4}.leaf-editor footer{display:flex;justify-content:flex-end;gap:8px;margin-top:auto;padding-top:10px}.leaf-editor footer button{padding:10px 16px;border-radius:10px;font-weight:800;cursor:pointer}.secondary{border:1px solid #d8dbd2;background:#fff}.primary{border:1px solid #242821;background:#242821;color:#fff}.primary:disabled{opacity:.4;cursor:not-allowed}@media(max-width:767px){.leaf-editor{width:100%;padding:18px}}
.segment-search{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:7px}.segment-search button{border:0;border-radius:9px;padding:0 12px;background:#efedfa;color:#5e4db1;font-weight:800}.field-error{color:#a64134!important}
</style>

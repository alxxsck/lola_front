...
<style scoped>
.segment-manager{display:flex;flex-direction:column;gap:12px;padding:16px;border:1px solid #dedbec;border-radius:16px;background:#fbfaff}.segment-manager>header{display:flex;align-items:flex-start;justify-content:space-between;gap:14px}.segment-manager h3{margin:3px 0 0;font-size:.9rem}.segment-manager header p{max-width:680px;margin:4px 0 0;color:var(--muted);font-size:.65rem;line-height:1.45}.primary,.secondary{padding:9px 12px;border-radius:9px;font-size:.65rem;font-weight:800;cursor:pointer}.primary{border:1px solid #282c25;background:#282c25;color:#fff}.primary:disabled{opacity:.4}.secondary{border:1px solid #d8dcd2;background:#fff}.search label{display:flex;align-items:center;gap:8px;padding:5px 5px 5px 11px;border:1px solid #dedfd9;border-radius:11px;background:#fff}.search input{flex:1;min-width:0;border:0;outline:0;font:inherit}.search button{padding:7px 10px;border:0;border-radius:7px;background:#efedf8;color:#6652b8;font-weight:800}.segments{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0;padding:0}.segments li{display:grid;grid-template-columns:minmax(0,1fr) auto;border:1px solid #e0e2dc;border-radius:12px;background:#fff;overflow:hidden}.segment-main{display:flex;flex-direction:column;align-items:flex-start;padding:11px;border:0;background:transparent;text-align:left;cursor:pointer}.segment-main strong{margin-top:5px;font-size:.72rem}.segment-main code{margin-top:2px;color:var(--muted);font-size:.6rem}.segment-main small{margin-top:7px;color:var(--muted);font-size:.58rem}.status{padding:3px 6px;border-radius:999px;background:#e8f4da;color:#55742d;font-size:.53rem;font-weight:900;text-transform:uppercase}.status.archived{background:#eceee9;color:#6c7169}.archive{width:38px;border:0;border-left:1px solid #eceee8;background:#fafbf8;color:#7c8178;cursor:pointer}.more{align-self:center;padding:7px 12px;border:1px solid #d9ddd4;border-radius:9px;background:#fff}.empty{display:flex;flex-direction:column;align-items:center;padding:22px;border:1px dashed #d8dcd3;border-radius:12px;color:var(--muted);text-align:center;font-size:.64rem}.empty strong{margin-top:6px;color:var(--ink)}.empty span{margin-top:4px}.detail-backdrop,.editor-backdrop{position:fixed;inset:0;z-index:1250;background:#1f231e66}.detail{position:absolute;top:0;right:0;width:min(520px,100%);height:100%;padding:22px;background:#fff;overflow:auto}.detail>header,.editor>header{display:flex;justify-content:space-between;gap:12px}.detail>header span,.editor>header span{color:#765fd0;font-size:.58rem;font-weight:900;text-transform:uppercase}.detail>header h3,.editor>header h3{margin:4px 0}.detail>header button,.editor>header button{width:34px;height:34px;border:0;border-radius:50%;background:#eff1ec}.detail>p{color:var(--muted);font-size:.68rem}.detail section{margin-top:18px}.detail h4{font-size:.7rem}.detail ol{display:flex;flex-direction:column;gap:7px;padding:0}.revision{display:grid;grid-template-columns:1fr auto;gap:4px;padding:10px;border:1px solid #e1e3dd;border-radius:10px}.revision strong,.revision span{font-size:.63rem}.revision code{grid-column:1/3;color:var(--muted);font-size:.56rem}.revision.current{border-color:#c9ddae;background:#f9fced}.detail section>small{color:var(--muted);font-size:.6rem}.editor-backdrop{z-index:1300;overflow:auto;padding:18px}.editor{width:min(1040px,100%);margin:auto;padding:20px;border-radius:18px;background:#fff}.fields{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin:16px 0}.fields label{display:flex;flex-direction:column;gap:5px}.fields span{font-size:.65rem;font-weight:800}.fields input,.fields textarea{padding:9px 10px;border:1px solid #d9dcd4;border-radius:9px;font:inherit}.fields small{color:var(--muted);font-size:.58rem}.fields .wide{grid-column:1/3}.editor>footer{display:flex;align-items:center;justify-content:flex-end;gap:8px;margin-top:14px}.editor>footer>div{margin-right:auto}.editor>footer strong,.editor>footer small{display:block}.editor>footer strong{font-size:.65rem}.editor>footer small{margin-top:3px;color:var(--muted);font-size:.58rem}.sr-only{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}@media(max-width:720px){.segment-manager>header{flex-direction:column}.segments{grid-template-columns:1fr}.editor-backdrop{padding:0}.editor{min-height:100%;border-radius:0;padding:14px}.fields{grid-template-columns:1fr}.fields .wide{grid-column:1}.editor>footer{align-items:stretch;flex-wrap:wrap}.editor>footer>div{width:100%}}
.recovery{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px 12px;border:1px solid #e6c77a;border-radius:10px;background:#fff8e7;font-size:.64rem}.recovery button{padding:7px 10px;border:1px solid #be8d27;border-radius:8px;background:#fff;color:#7d570e;font-weight:800;cursor:pointer}
</style>

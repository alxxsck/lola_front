...
vi.mock('@/shared/api/repository', () => ({
  repository: { getConversationAISuspensionHistory: mocks.history },
}));
...
describe('история приостановки AI', () => {
  it('показывает русские названия действий и не дублирует записи страниц', async () => {
    const item = {
      ...
      type: 'STARTED',
      version: '1',
      acceptedAt: '2026-07-20T13:00:00.000Z',
      actor: { id: 'admin-1', displayName: 'Алексей' },
      correlationId: 'request-1',
      reason: 'OPERATOR_TAKEOVER',
      note: 'Проверка',
      newSuspendedUntil: '2026-07-20T14:00:00.000Z',
    };

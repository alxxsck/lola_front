...
describe('projectAIOperationsRepository', () => {
  ...
  it('delegates every read to the generated Project-scoped API', async () => {
    ...
    await projectAIOperationsRepository.accessHistory('project-1', 'operation-1', { limit: 50 });
    ...
    expect(generated.subjects).toHaveBeenCalledWith('project-1', 'operation-1', {
      role: 'DATA_CONTRIBUTOR',
      limit: 50,
    });
    expect(generated.accessHistory).toHaveBeenCalledWith('project-1', 'operation-1', { limit: 50 });
  });
});

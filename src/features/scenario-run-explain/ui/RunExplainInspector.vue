...
<style scoped>
.run-explain{display:grid;gap:16px;padding-top:18px;border-top:1px solid var(--line)}header>span{color:var(--muted);font-size:.62rem;text-transform:uppercase;letter-spacing:.1em}header h3{margin:4px 0 0}header p,.empty-copy{margin:5px 0 0;color:var(--muted);font-size:.69rem}.explain-state,.explain-error{padding:12px;border-radius:11px;background:#f4f5f0}.explain-error{display:flex;align-items:center;justify-content:space-between;background:#fff0ed;color:#91493d}.explain-error button{border:0;border-radius:8px;padding:7px}.revision-card{display:flex;gap:10px;padding:13px;border-radius:13px;background:#eef6e7}.revision-card.unavailable{background:#f3f3ef}.revision-card strong,.revision-card span,.revision-card small{display:block}.revision-card strong{font-size:.77rem}.revision-card span,.revision-card small{margin-top:4px;font-size:.65rem}.revision-card a,.explain-section>a,.goal-list a{display:inline-block;margin-top:6px;color:#6651c6;font-size:.67rem}.explain-section{display:grid;gap:9px}.explain-section h4{margin:0;font-size:.83rem}.section-title{display:flex;align-items:center;justify-content:space-between;gap:10px}.section-title>span{color:var(--muted);font-size:.64rem}.fact-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.fact-grid>div{padding:9px;border-radius:9px;background:#f5f6f1}.fact-grid span,.fact-grid strong{display:block}.fact-grid span{color:var(--muted);font-size:.59rem}.fact-grid strong{margin-top:3px;font-size:.68rem}.eligibility-tree,.timeline{display:grid;gap:7px;margin:0;padding:0;list-style:none}.eligibility-tree li{margin-left:calc(var(--depth) * 10px);padding:9px;border:1px solid #eadbd7;border-radius:10px}.eligibility-tree li.matched{border-color:#cfe1c2}.eligibility-tree li.unavailable{border-color:#ddd9c8;background:#faf9f1}.eligibility-tree li>div{display:flex;align-items:center;gap:7px}.eligibility-tree li>div>span{color:var(--muted);font-size:.61rem}.eligibility-tree strong{font-size:.7rem}.eligibility-tree dl,.goal-list dl{display:grid;grid-template-columns:max-content 1fr;gap:3px 8px;margin:7px 0 0;font-size:.63rem}.eligibility-tree dt,.goal-list dt{color:var(--muted)}.eligibility-tree dd,.goal-list dd{margin:0;overflow-wrap:anywhere}.goal-list,.action-list{display:grid;gap:8px}.goal-list article,.action-list article{padding:10px;border:1px solid var(--line);border-radius:10px}.goal-list article>div{display:flex;justify-content:space-between;gap:8px}.goal-list strong,.goal-list span,.action-list strong,.action-list span,.action-list small{font-size:.68rem}.action-list strong,.action-list span,.action-list small{display:block}.action-list span,.action-list small{margin-top:3px;color:var(--muted)}.wait-list{display:grid;gap:5px}.wait-list span{padding:8px;border-radius:8px;background:#f5f6f1;font-size:.65rem}.timeline li{display:flex;gap:9px}.timeline i{margin-top:5px;color:#8871e6;font-size:.42rem}.timeline strong,.timeline span{display:block;font-size:.65rem}.timeline span{margin-top:2px;color:var(--muted)}@media(max-width:480px){.fact-grid{grid-template-columns:1fr}}
.snapshot-copy,.recheck-card p{margin:0;color:var(--muted);font-size:.66rem}.dependency-counts{display:flex;flex-wrap:wrap;gap:6px}.dependency-counts span{padding:5px 7px;border-radius:8px;background:#f0edff;color:#5948ac;font-size:.61rem}.dependency-ids{display:grid;gap:6px}.dependency-ids>div{display:flex;flex-wrap:wrap;gap:5px;align-items:center}.dependency-ids strong,.dependency-ids code{font-size:.6rem}.dependency-ids code{padding:3px 5px;border-radius:6px;background:#f5f6f1}.recheck-card{display:grid;gap:8px;padding:11px;border-left:3px solid #8871e6;border-radius:10px;background:#f7f5ff}
</style>

...
const response = {
  ...
  eligibility: {
    ...
    root: {
      kind: "eventField",
      matched: true,
      actual: { visibility: "REDACTED", value: "secret" },
      ...
      children: [
        {
          ...
          actual: { visibility: "REDACTED", value: "audience-secret" },
  ...
  goalResolutions: [
    {
      ...
      outcome: "TIMED_OUT",
      winner: "DEADLINE",
      selectedBranch: "onTimeout",
      targetNodeKey: "reminder",
    },
  ],
...
describe("RunExplainInspector", () => {
  ...
  it("shows pinned execution facts, redaction and the Goal race winner", async () => {
    const wrapper = mount(RunExplainInspector, {

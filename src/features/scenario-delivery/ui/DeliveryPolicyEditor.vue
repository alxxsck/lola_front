...
<style scoped>
.delivery-editor{display:grid;gap:18px;width:min(760px,100%)}.delivery-head span{color:var(--text-small-muted);font-size:.63rem;text-transform:uppercase;letter-spacing:.1em}.delivery-head h2{margin:5px 0 0;font-size:1.15rem}.delivery-head p,.online-controls p{margin:5px 0 0;color:var(--text-small-muted);font-size:.72rem}.policy-cards{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.policy-card{display:flex;gap:10px;padding:14px;border:1px solid var(--border-default);border-radius:14px;background:var(--surface-card);cursor:pointer}.policy-card.selected{border-color:var(--status-violet-text);background:var(--status-violet-soft);box-shadow:0 0 0 1px var(--status-violet-text)}.policy-card input{margin-top:3px}.policy-card strong,.policy-card small,.recheck strong,.recheck small{display:block}.policy-card strong,.recheck strong{font-size:.75rem}.policy-card small,.recheck small{margin-top:4px;color:var(--text-small-muted);font-size:.65rem;line-height:1.45}.online-controls{display:grid;gap:12px;padding:15px;border-radius:15px;background:var(--surface-card)}.duration-row{display:grid;grid-template-columns:1fr 1fr;gap:8px}.duration-row input,.duration-row select{min-height:40px;border:1px solid var(--border-default);border-radius:9px;background:var(--surface-card);padding:8px}.recheck{display:flex;align-items:flex-start;gap:9px}.recheck input{margin-top:3px}.delivery-summary{display:flex;gap:9px;padding:12px;border-radius:12px;background:var(--status-success-soft);color:var(--status-success-text);font-size:.7rem}@media(max-width:560px){.policy-cards{grid-template-columns:1fr}}
</style>

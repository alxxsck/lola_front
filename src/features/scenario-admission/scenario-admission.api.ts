...
export const scenarioAdmissionApi = {
  get(projectId: string) {
    ...
    return callApi(() => platformOperationsScenarioAdmissionSettings(projectId));
  },
  update(projectId: string, input: UpdateScenarioAdmissionSettingsDto) {
    ...
    return callApi(() => platformOperationsUpdateScenarioAdmissionSettings(projectId, input));
  },
  decisionsPage(projectId: string, params: ScenarioAdmissionDecisionsPageParams) {

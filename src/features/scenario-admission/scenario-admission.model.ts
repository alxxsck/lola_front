...
export type ScenarioImportanceClass =
  CreateScenarioAuthoringMetadataDtoImportanceClass;
...
export const importanceClassOptions: ReadonlyArray<{
  ...
  },
  {
    ...
    title: "Промо",
    description:
      "Предложение, акция или маркетинговое сообщение. В V1 применяются общие правила.",
  },
  {
    value: "GENERAL",
    title: "Общий",
    description:
      "Сценарий без специальной категории. В V1 применяются общие правила.",
  },
];
...
export function importanceClassPresentation(value: string) {
  return (
    importanceClassOptions.find((option) => option.value === value) ?? {
      ...
      description:
        "Сервер вернул новый класс важности. Значение сохранено без изменений.",
    }
  );
}

...
describe('Support Case External Work pane', () => {
      ...
      links: ref([
        {
          ...
          item: {
            ...
            allowedActions: ['OPEN_REMOTE', 'VIEW_TIMELINE', 'COMMENT_INTERNAL'],
          },
        },
      ]),
    });
  ...
  it('makes safe context explicit and states that chat history is not copied', async () => {
    ...
    expect(wrapper.text()).toContain('История чата не копируется автоматически');
      ...
      links: ref([
        {
          ...
          item: {
            ...
            remoteUrl: null,
            allowedActions: ['VIEW_TIMELINE', 'COMMENT_INTERNAL', 'COMMENT_PUBLIC'],
          },
        },
      ]),

...
.sla-lifecycle__step:last-child { border-right: 0; }
.sla-lifecycle__step.is-dirty { background: var(--status-warning-soft); }
...
.sla-lifecycle__step strong { display: block; }
.sla-lifecycle__step small {
  margin-bottom: 4px;
...
@media (max-width: 980px) {
  .sla-lifecycle { grid-template-columns: repeat(2, minmax(0, 1fr)); }
  .sla-lifecycle__step:nth-child(2) { border-right: 0; }
  .sla-lifecycle__step:nth-child(-n + 2) { border-bottom: 1px solid var(--line); }
}

@media (max-width: 560px) {
  .sla-lifecycle { grid-template-columns: 1fr; }
  .sla-lifecycle__step,
  ...
  .sla-lifecycle__step:last-child { border-bottom: 0; }
}
</style>

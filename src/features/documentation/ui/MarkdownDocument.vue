...
<style scoped>
.markdown-article{min-width:0;color:#30342d}.markdown-article :deep(h1){display:none}.markdown-article :deep(h2),.markdown-article :deep(h3){scroll-margin-top:26px}.markdown-article :deep(h2){display:flex;align-items:center;gap:12px;margin:48px 0 16px;padding-top:30px;border-top:1px solid var(--line);font-size:1.48rem}.markdown-article :deep(h2:first-of-type){margin-top:8px;padding-top:0;border-top:0}.markdown-article :deep(h3){margin:28px 0 10px;font-size:1rem;color:#343930}.heading-icon{display:grid;place-items:center;flex:0 0 38px;height:38px;border-radius:12px;background:#eeebff;color:#725bd2;font-size:.88rem}.markdown-article p{max-width:78ch;margin:0 0 14px;color:#555b51;font-size:.94rem;line-height:1.72}.markdown-article ul,.markdown-article ol{display:grid;gap:8px;max-width:78ch;margin:0 0 20px;padding-left:25px;color:#454a42}.markdown-article li{padding-left:4px;line-height:1.58}.markdown-article li::marker{color:#8069e2;font-weight:800}.markdown-article code{border-radius:6px;background:#f0f1ec;padding:2px 5px;color:#5b48ad;font:600 .84em ui-monospace,SFMono-Regular,Menlo,monospace}.code-example{max-width:78ch;margin:18px 0 24px;overflow:hidden;border:1px solid #dfe2da;border-radius:16px;background:#22251f;box-shadow:0 12px 30px rgba(35,39,31,.08)}.code-example figcaption{display:flex;align-items:center;gap:7px;padding:10px 14px;border-bottom:1px solid #3b4037;color:#aeb5a7;font-size:.68rem;text-transform:uppercase;letter-spacing:.1em}.code-example figcaption i{color:var(--accent)}.code-example pre{margin:0;padding:17px 18px;overflow:auto;color:#eef0e9;font:500 .78rem/1.65 ui-monospace,SFMono-Regular,Menlo,monospace}.code-example pre code{padding:0;background:transparent;color:inherit;font:inherit}@media(max-width:700px){.markdown-article :deep(h2){align-items:flex-start;font-size:1.25rem}.markdown-article p{font-size:.9rem}.code-example{border-radius:12px}}
</style>

...
<style scoped>
.revision-history{display:grid;gap:12px;padding-top:18px;border-top:1px solid var(--line)}header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}header span{color:var(--muted);font-size:.62rem;text-transform:uppercase;letter-spacing:.1em}header h2{margin:4px 0 0;font-size:1.05rem}header p{margin:4px 0 0;color:var(--muted);font-size:.68rem}.revision-list{display:grid;gap:8px}.revision-list article{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:8px;border:1px solid var(--line);border-radius:12px;background:#fff}.revision-list article.current{border-color:#b9d99e;background:#f5faef}.revision-main{display:grid;grid-template-columns:minmax(150px,1fr) minmax(100px,.7fr) auto auto;align-items:center;gap:9px;min-width:0;border:0;background:transparent;text-align:left;cursor:pointer}.revision-main strong,.revision-main small{display:block}.revision-main strong{font-size:.72rem}.revision-main small{margin-top:3px;color:var(--muted);font-size:.61rem}.revision-main code{overflow:hidden;color:var(--muted);font-size:.6rem;text-overflow:ellipsis}.revision-main em{padding:3px 6px;border-radius:7px;background:#dff0d2;color:#477039;font-size:.58rem;font-style:normal}.revision-detail{padding:13px;border-radius:12px;background:#f2f3ee}.revision-detail>div{display:flex;justify-content:space-between}.revision-detail button{border:0;background:transparent;font-size:1.1rem}.revision-detail dl{display:grid;grid-template-columns:max-content minmax(0,1fr);gap:6px 12px;margin:10px 0 0;font-size:.65rem}.revision-detail dt{color:var(--muted)}.revision-detail dd{min-width:0;margin:0;overflow-wrap:anywhere}@media(max-width:620px){.revision-list article{grid-template-columns:1fr}.revision-main{grid-template-columns:1fr auto}.revision-main code{grid-column:1/3}.revision-list article :deep(.p-button){width:100%}}
</style>

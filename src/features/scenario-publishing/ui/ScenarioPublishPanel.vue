...
<style scoped>
.validation-issue{display:grid!important;width:100%;margin-top:6px;text-align:left}.validation-issue code{font-size:.58rem;color:var(--status-danger-text)}
.publish-panel{display:grid;gap:16px;width:min(820px,100%);padding-top:18px;border-top:1px solid var(--line)}header>span{color:var(--text-small-muted);font-size:.63rem;text-transform:uppercase;letter-spacing:.1em}header h2{margin:5px 0 0;font-size:1.15rem}header p{margin:5px 0 0;color:var(--text-small-muted);font-size:.7rem}.review-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px}.review-grid article{display:flex;gap:9px;padding:12px;border:1px solid var(--border-default);border-radius:12px;background:var(--surface-card)}.review-grid i{color:var(--status-violet-text)}.review-grid strong,.review-grid span,.review-grid small{display:block}.review-grid strong{font-size:.72rem}.review-grid span{margin-top:4px;font-size:.66rem}.review-grid small{margin-top:5px;color:var(--text-small-muted);font-size:.61rem}.server-review{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.server-review>div,.review-state{padding:11px;border-radius:11px;background:var(--status-success-soft)}.server-review strong,.server-review span,.review-state strong,.review-state span{display:block;font-size:.66rem}.server-review span,.review-state span{margin-top:4px;color:var(--text-small-muted)}.review-state.error{background:var(--status-danger-soft);color:var(--status-danger-text)}.review-state button{border:0;border-radius:7px;padding:5px 8px}.document-dependencies{display:grid;gap:4px;padding:11px;border:1px solid var(--line);border-radius:11px}.document-dependencies strong,.document-dependencies span{font-size:.66rem}.document-dependencies span{color:var(--text-small-muted)}.diff-gap{margin:0;color:var(--text-small-muted);font-size:.65rem}.publish-issues{margin:0;padding:11px 11px 11px 30px;border-radius:12px;background:var(--status-danger-soft);color:var(--status-danger-text);font-size:.68rem}.conflict,.publish-error{padding:13px;border-radius:12px;background:var(--status-warning-soft);color:var(--status-warning-text)}.conflict p{font-size:.69rem}.conflict button{min-height:38px;border:0;border-radius:9px;background:var(--surface-emphasis);color:var(--text-on-emphasis);padding:8px 12px}.published-card{display:grid;gap:10px;padding:15px;border-radius:14px;background:var(--status-success-soft);color:var(--status-success-text)}.published-card>div{display:flex;gap:10px}.published-card strong,.published-card span{display:block}.published-card span,.published-card p,.published-card dl{font-size:.67rem}.published-card dl{display:grid;grid-template-columns:max-content 1fr;gap:5px 12px;margin:0}.published-card dd{margin:0}.publish-button{min-height:46px;border:0;border-radius:11px;background:var(--surface-emphasis);color:var(--text-on-emphasis);font-weight:700;cursor:pointer}.publish-button:disabled{cursor:not-allowed;opacity:.45}.session-warning{margin:0;color:var(--text-small-muted);font-size:.65rem}.session-warning i{color:var(--status-warning-text)}@media(max-width:720px){.review-grid,.server-review{grid-template-columns:1fr}}
</style>

...
export function scenarioApiErrorMessage(cause: unknown, fallback = 'Не удалось сохранить сценарий'): string {
  ...
  const translationMessages: Record<string, string> = {
    ...
    TRANSLATION_BUDGET_EXCEEDED: 'Лимит автоматических переводов проекта исчерпан. Проверьте бюджет в статистике переводов в настройках проекта.',
    TRANSLATION_GLOBAL_BUDGET_EXCEEDED: 'Общий лимит автоматических переводов исчерпан. Проверьте бюджет в статистике переводов в настройках проекта.',

...
const global = {
  stubs: {
    Dialog: {
      ...
      template: '<section v-if="visible" role="dialog"><slot /><footer><slot name="footer" /></footer></section>',
    },
    Button: {
    ...
    const wrapper = mount(ScenarioActionChangeDialog, {
      props: {
        ...
        preview: {
          ...
          plan: {
            replacement: { position: 0, nodeKey: 'question', nextNodeKey: null, type: 'SAY', config: {} },
            preservedConfigKeys: [],
      ...
      props: {
        ...
        preview: {
          ...
          plan: {
            ...
            removedIncomingTransitions: [{ source: 'open_form', target: 'open_chat', branchId: 'next', kind: 'default' }],
          },
        },
      },
      global,

...
.flow-node {
  ...
  box-shadow:
    inset 3px 0 0 var(--node-kind-color, var(--status-accent)),
    var(--shadow-raised);
  transition:
...
.flow-node.selected {
  ...
  box-shadow:
    inset 3px 0 0 var(--node-kind-color, var(--status-accent)),
    0 0 0 3px color-mix(in srgb, var(--status-accent) 13%, transparent),
    var(--shadow-raised);
}
.flow-node.invalid {
...
.kind-action {
  --node-kind-color: var(--status-accent);
  --node-kind-soft: var(--status-accent-soft);
  --node-kind-text: var(--status-accent-text);
}
.kind-decision {
  --node-kind-color: var(--status-warning);
  --node-kind-soft: var(--status-warning-soft);
  --node-kind-text: var(--status-warning-text);
}
.kind-wait {
  --node-kind-color: var(--status-info);
  --node-kind-soft: var(--status-info-soft);
  --node-kind-text: var(--status-info-text);
}
.kind-terminal {
  --node-kind-color: var(--status-success);
  --node-kind-soft: var(--status-success-soft);
  --node-kind-text: var(--status-success-text);
}
.node-head {
  display: flex;
...
.flow-node :deep(.vue-flow__handle) {
  border: 2px solid var(--graph-node);
  background: var(--graph-selection);
  box-shadow: 0 0 0 1px var(--graph-selection);
}

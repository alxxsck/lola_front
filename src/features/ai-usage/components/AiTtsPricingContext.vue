...
<template>
  <aside class="tts-pricing-context" aria-label="Тариф озвучивания текста">
    ...
    <div>
      ...
      <span> История рассчитана по ставке, действовавшей в момент каждой операции. </span>
...
.tts-pricing-context {
  ...
  gap: 10px;
  padding: 11px 13px;
  border: 1px solid color-mix(in srgb, var(--status-accent) 30%, var(--border-default));
  border-radius: 12px;

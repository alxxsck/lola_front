      ...
      >
        ...
        <template v-else>
          <div class="stat-top">
            ...
            <span v-if="item.label === 'Ошибки интеграции'" class="online-label"
              ><i /> HEALTHY</span
            >
          </div>
    ...
    <section class="dashboard-grid">
      <div class="card activity-card">
          ...
          >
            ...
            <div class="activity-copy">
              <div class="activity-title">
                ...
                ><Tag
                  :value="activityStatus(item.status)"
                  :severity="activitySeverity(item.status)"
                  rounded
                />
              </div>
              <p>
        ...
        <div v-else class="empty">
          <i class="pi pi-inbox" />Активность появится после первых событий.
        </div>
      </div>
...
.tone-lime {
  --card-color: var(--overview-tone-lime-foreground);
  --card-soft: var(--overview-tone-lime-soft);
}
.tone-green {
  --card-color: var(--overview-tone-green-foreground);
  --card-soft: var(--overview-tone-green-soft);
}
.tone-coral {

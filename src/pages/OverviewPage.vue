...
<style scoped>
.overview-page{position:relative}.overview-page:before{content:'';position:absolute;top:0;right:5%;width:280px;height:180px;background:radial-gradient(circle,color-mix(in srgb,var(--brand) 22%,transparent),transparent 70%);pointer-events:none}.overview-header{position:relative;align-items:center}.live-link{display:flex;align-items:center;gap:11px;min-width:220px;padding:12px 14px;background:var(--surface-card);border:1px solid var(--line);border-radius:15px;transition:.18s ease}.live-link:hover{transform:translateY(-2px);box-shadow:var(--shadow)}.live-link>span:nth-child(2){display:flex;flex-direction:column;flex:1}.live-link strong{font-size:.82rem}.live-link small{color:var(--muted);font-size:.7rem;margin-top:2px}.live-link>.pi{font-size:.75rem;color:var(--text-tertiary)}.live-indicator{display:grid;place-items:center;width:34px;height:34px;border-radius:11px;background:var(--status-success-soft)}.live-indicator i,.online-label i{width:7px;height:7px;background:var(--status-success);border-radius:50%;box-shadow:0 0 0 4px color-mix(in srgb,var(--status-success) 13%,transparent)}.dashboard-error{margin-bottom:18px}.error-row{display:flex;align-items:center;justify-content:space-between;gap:16px;width:100%}.stats-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px;margin-bottom:18px}.stat-card{min-height:184px;padding:20px;display:flex;flex-direction:column;gap:15px;overflow:hidden;position:relative}.stat-card:after{content:'';position:absolute;width:110px;height:110px;border-radius:50%;right:-45px;top:-42px;background:var(--card-color);opacity:.13}.stat-top{display:flex;align-items:center;justify-content:space-between}.stat-icon,.quick-icon{display:grid;place-items:center;width:42px;height:42px;border-radius:13px;background:var(--card-soft);color:var(--card-color)}.stat-icon i{font-size:.95rem}.stat-value{font:700 2rem var(--font-display);letter-spacing:-.05em;line-height:1}.stat-copy{display:flex;align-items:flex-end;justify-content:space-between;gap:8px}.stat-copy span{font-weight:600;font-size:.86rem}.stat-copy small{color:var(--muted);font-size:.67rem;text-align:right}.tone-lime{--card-color:var(--overview-tone-lime-foreground);--card-soft:var(--overview-tone-lime-soft)}.tone-green{--card-color:var(--overview-tone-green-foreground);--card-soft:var(--overview-tone-green-soft)}.tone-coral{--card-color:var(--overview-tone-coral-foreground);--card-soft:var(--overview-tone-coral-soft)}.tone-violet{--card-color:var(--overview-tone-violet-foreground);--card-soft:var(--overview-tone-violet-soft)}.online-label{display:flex;align-items:center;gap:7px;color:var(--status-success);font-size:.6rem;font-weight:700;letter-spacing:.1em}.online-label i{display:inline-block;width:5px;height:5px}.dashboard-grid{display:grid;grid-template-columns:minmax(0,1.6fr) minmax(300px,.8fr);gap:18px}.activity-card{padding:24px;min-width:0}.section-heading{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:18px}.section-heading .eyebrow{margin-bottom:5px}.section-link{font-size:.76rem;font-weight:600;color:var(--text-secondary)}.section-link i{font-size:.65rem;margin-left:5px}.activity-list{display:flex;flex-direction:column}.activity-item{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:13px;padding:14px 0;border-top:1px solid var(--border-subtle)}.activity-item:first-child{border-top:0}.activity-icon{display:grid;place-items:center;width:39px;height:39px;border-radius:12px;background:var(--surface-subtle);color:var(--text-secondary)}.activity-icon.failed{background:var(--status-danger-soft);color:var(--status-danger)}.activity-copy{min-width:0}.activity-title{display:flex;align-items:center;gap:8px;min-width:0}.activity-title strong{font-size:.83rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.activity-title :deep(.p-tag){font-size:.58rem;padding:.18rem .4rem;flex:0 0 auto}.activity-copy p{margin:4px 0 0;color:var(--muted);font-size:.74rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.activity-item time{font-size:.67rem;color:var(--text-small-muted);white-space:nowrap}.activity-skeleton{display:flex;align-items:center;gap:13px;padding:14px 0}.activity-skeleton>div{display:flex;flex-direction:column;gap:8px}.quick-panel{padding:24px;background:var(--surface-emphasis);color:var(--text-on-emphasis);border-radius:20px;min-width:0}.quick-panel .eyebrow{color:var(--text-on-emphasis-muted)}.quick-list{display:flex;flex-direction:column;gap:10px}.quick-card{display:grid;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:12px;padding:13px;background:var(--surface-emphasis-raised);border:1px solid var(--border-on-emphasis);border-radius:15px;transition:.18s ease}.quick-card:hover{background:var(--surface-emphasis-hover);transform:translateX(2px)}.quick-icon{width:38px;height:38px}.quick-card>span:nth-child(2){min-width:0}.quick-card strong,.quick-card small{display:block}.quick-card strong{font-size:.79rem}.quick-card small{margin-top:3px;color:var(--text-on-emphasis-muted);font-size:.66rem;line-height:1.3}.quick-card>.pi{font-size:.68rem;color:var(--text-on-emphasis-subtle)}.project-note{display:flex;align-items:center;gap:11px;padding:17px 2px 0;margin-top:18px;border-top:1px solid var(--border-on-emphasis)}.assistant-avatar{display:grid;place-items:center;width:37px;height:37px;border-radius:50%;background:var(--status-violet);color:var(--on-status-violet);font:700 .9rem var(--font-display)}.project-note>span:nth-child(2){display:flex;flex-direction:column;flex:1}.project-note small{font-size:.63rem;color:var(--text-on-emphasis-subtle)}.project-note strong{font-size:.79rem;margin-top:2px}.project-note-action{font-size:.68rem;color:var(--brand)}

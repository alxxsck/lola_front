...
<style scoped>
.scenarios-page{display:flex;flex-direction:column;gap:20px}.page-header{margin-bottom:0}.metric-strip{display:flex;align-items:center;padding:15px 18px;gap:26px}.metric-strip>div{display:flex;align-items:center;gap:10px;padding-right:26px;border-right:1px solid var(--line)}.metric-strip strong,.metric-strip small{display:block}.metric-strip strong{font:700 1.15rem Manrope;line-height:1}.metric-strip small{font-size:.7rem;color:var(--muted);margin-top:4px}.metric-icon{display:grid;place-items:center;width:34px;height:34px;border-radius:11px;font-size:.75rem}.metric-icon.active{background:#e7f6df;color:#4b984f}.metric-icon.draft{background:#f0edff;color:#725ccf}.metric-icon.actions{background:#fff1e9;color:#ce704e}.metric-strip p{margin:0 0 0 auto;color:var(--muted);font-size:.76rem}.metric-strip p i{color:var(--violet);margin-right:5px}.load-error{margin:0}.table-card{overflow:hidden}.table-toolbar{display:flex;align-items:center;gap:12px;padding:16px 18px;border-bottom:1px solid var(--line)}.search-box{position:relative;width:min(390px,100%)}.search-box>i{position:absolute;z-index:2;left:13px;top:50%;transform:translateY(-50%);color:#969b90;font-size:.8rem}.search-box .p-inputtext{padding-left:36px}.status-filter{width:170px}.result-count{margin-left:auto;color:var(--muted);font-size:.75rem}.scenario-table{cursor:default}.scenario-name,.trigger-cell{display:flex;align-items:center;gap:10px}.scenario-name strong,.scenario-name small,.trigger-cell strong,.trigger-cell small,.flow-cell strong,.flow-cell small{display:block}.scenario-name strong,.trigger-cell strong{font-size:.84rem}.scenario-name small,.trigger-cell small{color:var(--muted);font-size:.67rem;margin-top:4px}.scenario-mark{display:grid;place-items:center;flex:0 0 36px;height:36px;border-radius:11px;background:#22251f;color:var(--accent);font-size:.82rem}.trigger-cell>span{display:grid;place-items:center;width:29px;height:29px;border-radius:9px;background:#f1edff;color:#755fd2;font-size:.68rem}.flow-cell strong{font-size:.78rem}.flow-cell small{margin-top:4px;color:var(--muted);font-size:.69rem;white-space:nowrap;max-width:220px;overflow:hidden;text-overflow:ellipsis}.priority{display:inline-grid;place-items:center;min-width:32px;height:27px;padding:0 8px;border-radius:8px;background:#f1f2ed;font:700 .72rem Manrope}.updated-at{color:var(--muted);font-size:.75rem}.row-actions{display:flex;justify-content:flex-end}.empty strong{display:block;color:var(--ink);font-size:.95rem}.empty p{margin:6px 0 16px;font-size:.8rem}

...
<style scoped>
.header-actions{display:flex;align-items:center;gap:8px}.page-message{margin-bottom:16px}.message-row{display:flex;justify-content:space-between;align-items:center;gap:16px;width:100%}.loading-grid,.contract-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px;margin-bottom:16px}.summary-card,.schema-card{min-height:104px;padding:17px;display:flex;align-items:center;gap:13px}.summary-icon{display:grid;place-items:center;width:42px;height:42px;border-radius:13px;flex:0 0 auto}.summary-icon.lime{background:#f1f8d8;color:#759700}.summary-icon.violet{background:#efecff;color:#7059df}.summary-icon.green{background:#e8f7e9;color:#48a057}.summary-card small,.summary-card strong,.summary-card span{display:block}.summary-card small{text-transform:uppercase;letter-spacing:.08em;color:var(--muted);font-size:.58rem;font-weight:700}.summary-card strong{font:700 1.35rem Manrope;margin:3px 0}.summary-card span{color:#8b8f87;font-size:.63rem}.schema-card{width:100%;font:inherit;text-align:left;cursor:pointer;background:#292c26;color:white;border-color:#292c26}.schema-card>i:first-child{display:grid;place-items:center;width:42px;height:42px;border-radius:13px;background:#383c34;color:var(--accent)}.schema-card>span{flex:1}.schema-card strong,.schema-card small{display:block}.schema-card strong{font-size:.8rem}.schema-card small{color:#adb2a7;font-size:.65rem;margin-top:4px}.schema-card>i:last-child{color:#8f948a;font-size:.75rem}.breaking-note{display:flex;align-items:flex-start;gap:12px;padding:15px 17px;margin-bottom:16px;background:#fffdf4;border-color:#eee4bd}.breaking-note>i{color:#a58421;margin-top:2px}.breaking-note strong,.breaking-note span{display:block}.breaking-note strong{font-size:.79rem}.breaking-note span{color:#766f5a;font-size:.69rem;line-height:1.5;margin-top:3px}.attribute-list{display:flex;flex-direction:column;gap:9px}.attribute-card{display:grid;grid-template-columns:auto minmax(0,1fr) 120px auto;align-items:center;gap:15px;padding:16px 18px}.attribute-card.disabled{opacity:.62}.type-icon{display:grid;place-items:center;width:42px;height:42px;border-radius:13px;background:#f0edff;color:#7059df}.attribute-main{min-width:0}.attribute-title{display:flex;align-items:center;gap:8px;min-width:0}.attribute-title h2{font-size:.95rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.attribute-title code{font-size:.68rem;color:#62675e;background:#f2f2ee;padding:3px 6px;border-radius:6px}.attribute-main p{font-size:.72rem;color:var(--muted);margin:5px 0 8px}.attribute-flags{display:flex;gap:6px;flex-wrap:wrap}.attribute-flags span{font-size:.62rem;color:#747970;border:1px solid #e7e7e1;border-radius:7px;padding:4px 6px}.attribute-flags .required{color:#b6533d;background:#fff5f1;border-color:#f2dbd3}.attribute-flags i{font-size:.58rem;margin-right:3px}.attribute-state{display:flex;align-items:center;gap:8px;border-left:1px solid var(--line);padding-left:15px}.attribute-state>span{width:8px;height:8px;border-radius:50%;background:#b6b9b2}.attribute-state>span.on{background:#62bd6c;box-shadow:0 0 0 4px #e8f7e9}.attribute-state strong,.attribute-state small{display:block}.attribute-state strong{font-size:.68rem}.attribute-state small{font-size:.6rem;color:var(--muted);margin-top:3px}.attribute-actions{display:flex}.empty strong{display:block;color:var(--ink)}.empty p{margin:7px 0 16px}.attribute-form{display:flex;flex-direction:column;gap:16px;padding-top:3px}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.field label span,.field small{font-weight:400;color:#94988f}.field small{font-size:.67rem}.constraints{padding:14px}.constraints>strong{display:block;font-size:.78rem;margin-bottom:11px}.toggle-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px}.toggle-card{display:flex;align-items:center;justify-content:space-between;gap:15px;padding:13px 14px}.toggle-card.full{grid-column:1/-1}.toggle-card strong,.toggle-card span{display:block}.toggle-card strong{font-size:.77rem}.toggle-card span{color:var(--muted);font-size:.66rem;line-height:1.4;margin-top:3px}.schema-meta{display:flex;justify-content:space-between;gap:12px;margin-bottom:10px;color:var(--muted);font-size:.68rem}.schema-meta code{overflow:hidden;text-overflow:ellipsis}.schema-json{margin:0;max-height:65vh;overflow:auto;padding:17px;border-radius:14px;background:#252821;color:#dce7c1;font:500 .7rem/1.55 ui-monospace,monospace;white-space:pre-wrap;overflow-wrap:anywhere}

...
.signal-card {
  ...
  width: min(390px, 90%);
  padding: 16px;
  background: color-mix(in srgb, var(--text-on-emphasis) 8%, transparent);
  border: 1px solid color-mix(in srgb, var(--text-on-emphasis) 12%, transparent);
  border-radius: 18px;

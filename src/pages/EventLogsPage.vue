...
<style scoped>
.header-actions{display:flex;align-items:center;gap:10px}.view-switch{display:flex;padding:4px;background:var(--surface-active);border-radius:13px}.view-switch button{display:flex;align-items:center;gap:6px;border:0;background:transparent;color:var(--text-secondary);padding:8px 10px;border-radius:9px;cursor:pointer;font-size:.72rem;font-weight:700}.view-switch button.active{background:var(--surface-card);color:var(--ink);box-shadow:var(--shadow-raised)}.filter-panel{padding:17px;margin-bottom:12px}.filter-main,.filter-advanced{display:grid;grid-template-columns:1.2fr 1.1fr .75fr .75fr;gap:10px}.filter-advanced{padding-top:13px;margin-top:13px;border-top:1px solid var(--line)}.filter-panel .field{gap:5px;min-width:0}.filter-panel :deep(.p-multiselect){width:100%;min-width:0}.filter-panel :deep(.p-multiselect-label-container),.filter-panel :deep(.p-multiselect-label){min-width:0;overflow:hidden}.filter-panel .field label{font-size:.66rem;text-transform:uppercase;letter-spacing:.07em;color:var(--text-secondary)}.input-icon{position:relative}.input-icon>i{position:absolute;left:12px;top:50%;transform:translateY(-50%);color:var(--text-secondary);z-index:1}.input-icon :deep(input){padding-left:36px}.filter-panel footer{display:flex;align-items:center;justify-content:flex-end;gap:8px;padding-top:13px}.advanced-button{margin-right:auto;border:0;background:transparent;color:var(--text-secondary);font-size:.7rem;font-weight:700;cursor:pointer;padding:8px}.advanced-button i{margin-right:5px}.filter-count{font-size:.65rem;color:var(--text-brand);background:var(--brand-soft);padding:5px 8px;border-radius:9px}.limit-select{width:160px}.stream-summary{display:flex;gap:18px;align-items:center;min-height:35px;padding:0 6px;color:var(--text-secondary);font-size:.66rem;overflow:auto;white-space:nowrap}.stream-summary span:first-child{margin-right:auto}.stream-summary i{margin-right:5px}.stream-summary .danger{color:var(--status-danger-text)}.message-row{display:flex;align-items:center;justify-content:space-between;gap:16px;width:100%}.loading-list{display:grid;gap:9px;padding:16px}.log-table{overflow:hidden}.log-table :deep(tbody tr){cursor:pointer}.event-cell{display:flex;align-items:center;gap:10px}.event-dot{width:9px;height:9px;border-radius:50%;background:var(--status-warning);box-shadow:0 0 0 4px var(--status-warning-soft)}.event-dot.processed{background:var(--status-success);box-shadow:0 0 0 4px var(--status-success-soft)}.event-dot.failed{background:var(--status-danger);box-shadow:0 0 0 4px var(--status-danger-soft)}.event-cell strong,.event-cell small,.user-cell strong,.user-cell small,.time-cell strong,.time-cell small{display:block}.event-cell strong{font-size:.78rem}.event-cell small,.user-cell small,.time-cell small{font-size:.63rem;color:var(--muted);margin-top:3px}.user-cell strong{font-size:.69rem}.payload-pills{display:flex;gap:5px;align-items:center;max-width:390px;overflow:hidden}.payload-pills span{max-width:145px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding:4px 6px;border-radius:7px;background:var(--surface-subtle);color:var(--text-small-muted);font-size:.62rem}.payload-pills b{color:var(--text-small-muted);margin-right:3px}.payload-pills small{font-size:.61rem;color:var(--muted)}.time-cell strong{font-size:.7rem}.timeline{padding:22px}.timeline>header{display:flex;align-items:center;justify-content:space-between;padding:0 4px 17px;border-bottom:1px solid var(--line)}.timeline-kicker{font-size:.6rem;text-transform:uppercase;letter-spacing:.1em;color:var(--text-secondary);font-weight:700}.timeline h2{font-size:1rem;margin-top:3px}.timeline-list{padding-top:4px}.timeline-item{position:relative;display:grid;grid-template-columns:24px 78px minmax(0,1fr) auto 18px;align-items:center;gap:10px;width:100%;border:0;background:transparent;color:inherit;text-align:left;padding:13px 5px;cursor:pointer;border-radius:12px}.timeline-item:hover{background:var(--surface-hover)}.timeline-rail{position:relative;align-self:stretch;display:flex;justify-content:center}.timeline-rail:before,.timeline-rail:after{content:'';position:absolute;left:11px;width:1px;background:var(--border-default)}.timeline-rail:before{top:-13px;height:calc(50% + 13px)}.timeline-rail:after{top:50%;bottom:-13px}.timeline-item:first-child .timeline-rail:before,.timeline-item:last-child .timeline-rail:after{display:none}.timeline-rail i{position:relative;z-index:1;align-self:center;width:9px;height:9px;border-radius:50%;background:var(--status-warning);box-shadow:0 0 0 4px var(--status-warning-soft)}.timeline-rail i.processed{background:var(--status-success);box-shadow:0 0 0 4px var(--status-success-soft)}.timeline-rail i.failed{background:var(--status-danger);box-shadow:0 0 0 4px var(--status-danger-soft)}.timeline-time strong,.timeline-time small{display:block}.timeline-time strong{font-size:.7rem}.timeline-time small{font-size:.61rem;color:var(--text-small-muted);margin-top:3px}.timeline-body{min-width:0}.timeline-title{display:flex;gap:8px;align-items:center}.timeline-title strong{font-size:.78rem}.timeline-title code{font-size:.62rem;color:var(--text-small-muted)}.timeline-user{display:block;font-size:.63rem;color:var(--text-small-muted);margin-top:4px}.timeline-payload{display:flex;gap:5px;margin-top:7px}.timeline-payload>span{font-size:.6rem;background:var(--surface-subtle);border-radius:6px;padding:3px 5px;max-width:180px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.timeline-payload b{color:var(--text-small-muted)}.open-icon{font-size:.65rem;color:var(--text-secondary)}.pagination{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:16px 2px}.pagination>span{font-size:.7rem;color:var(--muted)}.pagination>div{display:flex;gap:8px}.drawer-title h2{font-size:1.15rem}.detail-stack{display:flex;flex-direction:column;gap:16px}.detail-hero{display:grid;grid-template-columns:1fr 1fr;gap:9px;padding:13px;background:var(--surface-subtle);border-radius:14px}.detail-hero>div{min-width:0;padding:5px}.detail-hero span,.detail-hero strong{display:block}.detail-hero span{font-size:.58rem;color:var(--text-small-muted);text-transform:uppercase;letter-spacing:.08em;margin-bottom:5px}.detail-hero strong{font-size:.72rem;overflow:hidden;text-overflow:ellipsis}.detail-stack :deep(.p-message p){margin:5px 0 0;font-size:.73rem}.detail-section{border:1px solid var(--line);border-radius:15px;overflow:hidden}.detail-section>header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:13px 14px;background:var(--surface-subtle);border-bottom:1px solid var(--line)}.detail-section>header>div{display:flex;align-items:center;gap:10px}.section-index{display:grid;place-items:center;width:29px;height:29px;border-radius:9px;background:var(--status-violet-soft);color:var(--status-violet);font-size:.62rem;font-weight:800}.detail-section h3{font-size:.82rem;margin:0}.detail-section header p{font-size:.63rem;color:var(--text-small-muted);margin:2px 0 0}.detail-section pre{margin:0;max-height:320px;overflow:auto;padding:14px;background:var(--code-background);color:var(--code-text);font:500 .68rem/1.55 ui-monospace,monospace;white-space:pre-wrap;overflow-wrap:anywhere}.identity-grid{display:grid;grid-template-columns:1fr 1fr;gap:0}.identity-grid>div{padding:12px 14px;min-width:0}.identity-grid>div:nth-child(odd){border-right:1px solid var(--line)}.identity-grid>div:nth-child(-n+2){border-bottom:1px solid var(--line)}.identity-grid span,.identity-grid code{display:block}.identity-grid span{font-size:.58rem;text-transform:uppercase;color:var(--text-small-muted);margin-bottom:5px}.identity-grid code{font-size:.65rem;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.timestamps{display:flex;justify-content:space-between;gap:10px;color:var(--text-small-muted);font-size:.62rem}.empty strong{display:block;color:var(--ink)}.empty p{margin:7px 0 16px}

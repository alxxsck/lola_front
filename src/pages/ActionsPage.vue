...
<style scoped>
.actions-page{display:flex;flex-direction:column;gap:20px}.page-header{margin-bottom:0}.action-hero{display:flex;align-items:center;justify-content:space-between;gap:28px;padding:18px 20px;background:var(--surface-emphasis);color:var(--text-on-emphasis);border-color:var(--surface-emphasis);overflow:hidden}.hero-copy{display:flex;align-items:center;gap:14px;min-width:0}.hero-icon{display:grid;place-items:center;flex:0 0 44px;height:44px;border-radius:14px;background:var(--accent);color:var(--surface-emphasis)}.hero-copy strong{font:700 .9rem Manrope}.hero-copy p{margin:4px 0 0;color:var(--text-on-emphasis-muted);font-size:.74rem}.hero-metrics{display:flex;align-items:center}.hero-metrics>div{min-width:90px;padding:0 18px;border-left:1px solid var(--border-on-emphasis)}.hero-metrics strong,.hero-metrics span{display:block}.hero-metrics strong{font:700 1.2rem Manrope;color:var(--text-on-emphasis)}.hero-metrics span{margin-top:3px;color:var(--text-on-emphasis-muted);font-size:.66rem}.catalog{overflow:hidden}.catalog-toolbar{display:flex;align-items:center;gap:12px;padding:16px 18px;border-bottom:1px solid var(--line)}.search-box{position:relative;width:min(430px,100%)}.search-box>i{position:absolute;z-index:2;left:13px;top:50%;transform:translateY(-50%);color:var(--text-secondary);font-size:.8rem}.search-box .p-inputtext{padding-left:36px}.status-filter{width:180px}.result-count{margin-left:auto;color:var(--muted);font-size:.75rem}.action-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;padding:18px}.action-card{position:relative;display:flex;align-items:flex-start;gap:13px;width:100%;padding:17px;border:1px solid var(--line);border-radius:16px;background:var(--surface-card);color:inherit;text-align:left;cursor:pointer;transition:transform .18s ease,border-color .18s ease,box-shadow .18s ease}.action-card:hover{transform:translateY(-2px);border-color:var(--border-default);box-shadow:var(--shadow-raised)}.action-card.disabled{background:var(--surface-subtle)}.action-icon,.dialog-icon{display:grid;place-items:center;flex:0 0 42px;height:42px;border-radius:13px}.action-icon.frontend,.dialog-icon.frontend{background:var(--status-violet-soft);color:var(--status-violet-text)}.action-icon.server,.dialog-icon.server{background:var(--status-success-soft);color:var(--status-success-text)}.action-main{display:block;min-width:0;flex:1}.action-topline{display:flex;align-items:center;gap:8px}.action-topline strong{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font:700 .86rem Manrope}.action-main code,.dialog-intro code{display:block;margin-top:5px;color:var(--text-secondary);font-size:.65rem}.description{display:-webkit-box;min-height:36px;margin-top:9px;overflow:hidden;color:var(--muted);font-size:.74rem;line-height:1.45;-webkit-line-clamp:2;-webkit-box-orient:vertical}.action-meta{display:flex;flex-wrap:wrap;gap:12px;margin-top:12px;color:var(--text-secondary);font-size:.65rem}.action-meta i{margin-right:4px}.open-icon{margin:3px 0 0 auto;color:var(--text-secondary);font-size:.72rem}.skeleton-card{cursor:default}.skeleton-card>div{display:flex;flex:1;flex-direction:column;gap:9px}.dialog-intro{display:flex;align-items:center;gap:13px}.dialog-tags{display:flex;gap:7px}.dialog-description{margin:16px 0;color:var(--text-secondary);font-size:.86rem}.execution-card{display:grid;grid-template-columns:1fr 1fr;gap:1px;padding:1px;border-radius:14px;background:var(--line);overflow:hidden}.execution-card>div{padding:14px;background:var(--surface-subtle)}.execution-card small,.execution-card strong{display:block}.execution-card small{color:var(--muted);font-size:.66rem;text-transform:uppercase;letter-spacing:.08em}.execution-card strong{margin-top:5px;font-size:.78rem}.settings-section{margin-top:24px}.section-title{display:flex;align-items:center;justify-content:space-between}.section-title h3{margin:0;font-size:1rem}.section-title p{margin:4px 0 0;color:var(--muted);font-size:.72rem}.section-title>span{display:grid;place-items:center;width:31px;height:31px;border-radius:10px;background:var(--surface-subtle);font:700 .72rem Manrope}.field-list{display:flex;flex-direction:column;gap:8px;margin-top:13px}.field-card{display:grid;grid-template-columns:30px minmax(0,1fr) auto;align-items:start;gap:11px;padding:13px;border:1px solid var(--line);border-radius:13px}.field-number{display:grid;place-items:center;width:28px;height:28px;border-radius:9px;background:var(--surface-emphasis);color:var(--text-on-emphasis);font:700 .65rem Manrope}.field-copy>div{display:flex;align-items:center;gap:8px}.field-copy strong{font-size:.79rem}.field-copy code{display:block;margin-top:4px;color:var(--text-secondary);font-size:.64rem}.field-copy p{margin:6px 0 0;color:var(--muted);font-size:.68rem}.control-type{padding:5px 8px;border-radius:8px;background:var(--status-violet-soft);color:var(--status-violet-text);font-size:.65rem;white-space:nowrap}.no-settings{display:flex;align-items:center;gap:11px;margin-top:13px;padding:16px;border-radius:13px;background:var(--status-success-soft);color:var(--status-success-text)}.no-settings>i{font-size:1.25rem}.no-settings strong,.no-settings span{display:block}.no-settings strong{font-size:.8rem}.no-settings span{margin-top:3px;font-size:.7rem;color:var(--status-success-text)}@media(max-width:900px){.action-hero{align-items:stretch;flex-direction:column}.hero-metrics>div:first-child{border-left:0;padding-left:0}.action-grid{grid-template-columns:1fr}}@media(max-width:620px){.catalog-toolbar{flex-wrap:wrap}.search-box,.status-filter{width:100%}.result-count{margin-left:0}.hero-metrics{justify-content:space-between}.hero-metrics>div{min-width:0;flex:1;padding:0 10px}.execution-card{grid-template-columns:1fr}.field-card{grid-template-columns:30px 1fr}.control-type{grid-column:2;justify-self:start}}
</style>

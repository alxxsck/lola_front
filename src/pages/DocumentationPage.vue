...
const guides = [
  {
    ...
    description:
      'Первый вход, очередь, обращения, ответы, заметки, переводы, назначения, SLA и завершение смены.',
  ...
  },
  {
    ...
    description:
      'Контроль очередей и нагрузки, риски SLA, назначения, материалы, интеграции и безопасный запуск.',
  ...
  },
  {
    ...
    description:
      'От событий, аудитории и условий до действий, ожиданий, публикации и безопасного отката.',
    icon: 'pi pi-sitemap',
  ...
  },
  {
    ...
    description:
      'Создание полей, обязательность, версии, публикация, зависимости, архивирование и качество данных.',
    icon: 'pi pi-id-card',
  ...
  },
  {
    ...
    description:
      'Конструктор правил, свежесть данных, проверки, версии, сценарии и пять практических примеров.',
    icon: 'pi pi-users',
  ...
  <section class="documentation-page">
    <header class="documentation-hero">
      <div class="hero-copy">
        ...
        <p>
          Понятные руководства по настройке Retenive — от первого сценария до ежедневной работы с
    ...
    <div class="guide-grid">
      <RouterLink v-for="guide in guides" :key="guide.title" :to="guide.to" class="guide-card">
        ...
        <span class="guide-card-copy"
          ...
          ><span>{{ guide.description }}</span></span
        >
        <span class="guide-meta"
          ><span v-for="item in guide.meta" :key="item"
            ><i class="pi pi-check" /> {{ item }}</span
          ></span
        >
    ...
    <aside class="documentation-note">
      ...
      <div>
        <strong>Начните с руководства перед настройкой</strong>
        <p>
          Каждая статья объясняет не только кнопки, но и последствия публикации, версии, ограничения
          и безопасный порядок работы.
        </p>
      </div>
    </aside>
  </section>
...
.documentation-hero {
  ...
  background: linear-gradient(
    ...
    var(--surface-emphasis-raised) 62%,
    var(--brand-soft) 100%
  );
...
.card-back {
  ...
  color: var(--surface-emphasis-raised);
}
.card-middle {
  right: 58px;
  top: 0;
...
.guide-card {
  ...
  background: linear-gradient(
    135deg,
    var(--surface-card) 0%,
    var(--status-accent-soft) 68%,
    var(--status-success-soft) 140%
  );
  box-shadow: var(--shadow-raised);
  transition:
...
.guide-card-copy strong {
  margin-top: 5px;
  color: var(--ink);
  font: 750 1.16rem/1.25 var(--font-display);
}
.guide-card-copy > span {
  max-width: 58ch;
  margin-top: 8px;

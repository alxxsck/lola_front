...
<style scoped>
.mb{margin-bottom:16px}.section-tabs{display:flex;gap:8px;margin-bottom:14px;padding:5px;background:var(--surface-subtle);border-radius:15px;width:max-content;max-width:100%;overflow:auto}.section-tabs button{display:flex;align-items:center;gap:8px;border:0;background:transparent;padding:10px 13px;border-radius:11px;color:var(--text-secondary);font-weight:600;white-space:nowrap;cursor:pointer}.section-tabs button.active{background:var(--surface-card);color:var(--ink);box-shadow:var(--shadow-raised)}.section-tabs strong{padding:2px 7px;background:var(--border-default);border-radius:10px;font-size:.66rem}.section-tabs .active strong{background:var(--accent)}.filters{display:grid;grid-template-columns:minmax(260px,1fr) 220px auto;align-items:center;gap:12px;padding:14px;margin-bottom:18px}.search{position:relative}.search>i{position:absolute;left:14px;top:50%;transform:translateY(-50%);z-index:2;color:var(--text-secondary)}.search :deep(input){padding-left:40px}.data-source{font-size:.7rem;color:var(--muted);white-space:nowrap}.data-source i{margin-right:5px}.table-card{overflow:hidden}.table-card :deep(tbody tr){cursor:pointer}.loading-list{display:grid;gap:10px;padding:18px}.primary-cell strong,.primary-cell small{display:block}.primary-cell strong{font-size:.82rem}.primary-cell small{font-size:.68rem;color:var(--muted);margin-top:3px}.compact{font-size:.72rem}.detail-stack{display:flex;flex-direction:column;gap:20px}.detail-hero{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;padding:14px;background:var(--surface-subtle);border-radius:14px}.detail-hero>div{min-width:0}.detail-hero span,.detail-hero strong{display:block}.detail-hero>div>span{font-size:.62rem;color:var(--muted);text-transform:uppercase;letter-spacing:.08em;margin-bottom:6px}.detail-hero strong{font-size:.78rem;overflow:hidden;text-overflow:ellipsis}.detail-stack h3{font-size:.9rem;margin:0 0 9px}.detail-stack pre{white-space:pre-wrap;overflow-wrap:anywhere;margin:0;padding:12px;border:1px solid var(--line);background:var(--surface-emphasis);color:var(--status-success);border-radius:12px;font:500 .69rem/1.55 'SFMono-Regular',Consolas,monospace}.steps{display:flex;flex-direction:column;gap:11px}.step-card{display:grid;grid-template-columns:34px 1fr;gap:11px}.step-index{display:grid;place-items:center;width:30px;height:30px;border-radius:10px;background:var(--status-violet-soft);color:var(--status-violet-text);font-weight:700;font-size:.75rem}.step-copy{padding:13px;border:1px solid var(--line);border-radius:14px;min-width:0}.step-copy>div:first-child{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:9px}.step-copy strong{font-size:.78rem}.step-copy pre{font-size:.65rem}.error-code{display:block;color:var(--status-danger-text);margin-bottom:8px}.command{display:grid;grid-template-columns:1fr auto;gap:7px;margin-top:10px;padding:10px;background:var(--surface-subtle);border-radius:10px}.command span{font-size:.7rem;font-weight:700}.command small{grid-column:1/-1;color:var(--muted)}

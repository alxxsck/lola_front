...
import type { EventDefinition, Scenario, ScenarioAction, ScenarioStatus, UiElement } from '@/shared/types/domain'
...
const form = reactive<ScenarioForm>({
  ...
  conditions: [], cooldownSeconds: undefined, maxRunsPerUser: undefined, actions: [],
})
  ...
  try {
    ...
    if (scenario) {
      Object.assign(form, {
        ...
        eventDefinitionId: scenario.eventDefinitionId, status: scenario.status, priority: scenario.priority,

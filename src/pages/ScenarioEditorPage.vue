...
.audience-canvas{position:relative;display:grid;align-content:start;gap:14px;min-width:0;min-height:0;overflow:auto;padding:18px;background:#f6f7f2}
.status-readonly{display:flex;align-items:center;gap:9px;padding:11px;border:1px solid #cfe3c0;border-radius:11px;background:#edf7e5;color:#415c31}.status-readonly strong,.status-readonly small{display:block}.status-readonly small{margin-top:2px;color:#607951;font-size:.62rem}
.delivery-stage{display:grid;gap:14px;width:min(820px,100%)}
.mobile-action-outline{display:none}.mobile-action-outline header span,.mobile-action-outline header strong{display:block}.mobile-action-outline header span{color:var(--muted);font-size:.62rem;text-transform:uppercase}.mobile-action-outline header small{color:var(--muted);font-size:.66rem}.mobile-node-card{display:grid;grid-template-columns:34px minmax(0,1fr) auto auto;align-items:center;gap:9px;width:100%;border:1px solid var(--line);border-radius:12px;background:#fff;padding:10px;text-align:left}.mobile-node-card>span{display:grid;place-items:center;width:32px;height:32px;border-radius:9px;background:#efebff;color:#6c55ce}.mobile-node-card strong,.mobile-node-card small{display:block}.mobile-node-card strong{font-size:.72rem}.mobile-node-card small{margin-top:3px;color:var(--muted);font-size:.63rem}.mobile-node-card em{display:grid;place-items:center;min-width:20px;height:20px;border-radius:10px;background:#fff0ed;color:#a2473b;font-size:.62rem;font-style:normal}.mobile-library{border:1px solid var(--line);border-radius:12px;background:#fff;padding:11px}.mobile-library summary{cursor:pointer;font-weight:700}.mobile-library>div{display:grid;gap:6px;margin-top:10px}.mobile-library>div>strong{color:var(--muted);font-size:.62rem;text-transform:uppercase}.mobile-library button{min-height:40px;border:0;border-radius:9px;background:#f4f2ff;color:#5948ac;text-align:left;padding:9px}.mobile-library button i{margin-right:7px}.mobile-empty{color:var(--muted);font-size:.7rem}

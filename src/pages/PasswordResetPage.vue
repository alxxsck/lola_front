...
<style scoped>
.reset-page{display:grid;min-height:100dvh;place-items:center;padding:24px;background:var(--surface-canvas)}.reset-card{display:flex;width:min(540px,100%);flex-direction:column;align-items:stretch;padding:34px;border:1px solid var(--border-default);border-radius:24px;background:var(--surface-card);box-shadow:var(--shadow-dialog)}.brand{display:flex;align-items:center;justify-content:center;gap:10px;margin-bottom:32px}.brand span{display:grid;width:38px;height:38px;place-items:center;border-radius:12px;background:var(--brand-primary);color:var(--on-action-primary);font-weight:800;transform:rotate(-3deg)}.brand strong{font-family:var(--font-display);font-size:1.05rem}.reset-card h1{margin:8px 0 10px;font-size:clamp(1.7rem,5vw,2.25rem);text-align:center}.reset-card>p{margin:0 0 22px;color:var(--muted);line-height:1.5;text-align:center}.reset-card form{display:flex;flex-direction:column;gap:18px}.field{display:flex;flex-direction:column;gap:8px}.field small,.inert-note{color:var(--muted);line-height:1.4}.reset-card :deep(.p-button){justify-content:center}.safe-link{align-self:center;margin-top:18px;padding:8px;color:var(--text-link);font-weight:700}.inert-note{margin-top:14px;text-align:center}

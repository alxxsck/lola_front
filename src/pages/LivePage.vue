...
<style scoped>
.mb{margin-bottom:16px}.live-label{color:#4d9a55}.live-label i{display:inline-block;width:7px;height:7px;border-radius:50%;background:#69c573;margin-right:6px;box-shadow:0 0 0 5px #e5f5e7}.summary-grid{display:grid;grid-template-columns:minmax(0,1.4fr) minmax(280px,.6fr);gap:16px;margin-bottom:34px}.summary-card{position:relative;min-height:174px;padding:22px 24px;border:1px solid var(--line);border-radius:22px;background:#fff;display:flex;flex-direction:column;overflow:hidden}.summary-card.lime{background:linear-gradient(135deg,var(--accent) 0%,#e2ff85 100%);border-color:#c7ec50}.summary-card.lime:after{content:'';position:absolute;right:-42px;bottom:-92px;width:220px;height:220px;border:42px solid rgba(255,255,255,.28);border-radius:50%;pointer-events:none}.connections-card{background:linear-gradient(145deg,#fff 0%,#fafaf6 100%)}.connections-card:after{content:'';position:absolute;right:-38px;bottom:-50px;width:132px;height:132px;border-radius:50%;background:radial-gradient(circle,rgba(112,89,223,.1),rgba(112,89,223,0) 70%);pointer-events:none}.summary-head{position:relative;z-index:1;display:flex;align-items:center;justify-content:space-between;gap:16px}.summary-head>span:first-child{text-transform:uppercase;letter-spacing:.09em;font-size:.68rem;font-weight:700;color:#666c61}.live-pill{display:flex;align-items:center;gap:7px;padding:6px 9px;border:1px solid rgba(70,96,22,.14);border-radius:999px;background:rgba(255,255,255,.42);color:#527522;font-size:.6rem;font-weight:800;letter-spacing:.1em;text-transform:uppercase}.live-pill i{width:6px;height:6px;border-radius:50%;background:#5ba950;box-shadow:0 0 0 4px rgba(91,169,80,.13)}.summary-icon{display:grid;place-items:center;width:34px;height:34px;border-radius:11px;background:#f0edff;color:#6e58d1}.summary-icon i{font-size:.78rem}.summary-main{position:relative;z-index:1;display:flex;align-items:flex-end;gap:22px;margin-top:auto}.summary-main>strong{flex:0 0 auto;font:700 3.4rem/1 Manrope;letter-spacing:-.07em}.summary-main>div{min-width:0;padding-bottom:3px}.summary-main b,.summary-main small{display:block}.summary-main b{margin-bottom:5px;font-size:.82rem}.summary-main small{color:#70756b;font-size:.7rem;line-height:1.35}.summary-main small i{margin-right:5px}.section-title{display:flex;justify-content:space-between;align-items:end;margin-bottom:16px}.section-title p{margin:5px 0 0;color:var(--muted);font-size:.78rem}.updated{font-size:.7rem;color:#4d9a55;text-transform:uppercase;letter-spacing:.08em;font-weight:700}.updated i{font-size:.65rem;margin-right:5px}.session-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.session-card{padding:18px;transition:.18s ease}.session-card:hover{transform:translateY(-2px);box-shadow:var(--shadow)}.session-card.idle{opacity:.76}.session-top{display:flex;align-items:center;gap:10px}.session-top>div:nth-child(2){flex:1;min-width:0}.session-top strong,.session-top span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.session-top strong{font-size:.86rem}.session-top span{font-size:.63rem;color:var(--muted);margin-top:3px}.session-avatar{position:relative;width:40px;height:40px;display:grid;place-items:center;background:#eeeafb;color:#6e58d1;border-radius:13px;font-weight:700}.session-avatar i{position:absolute;width:9px;height:9px;border-radius:50%;background:#6ac674;border:2px solid white;right:-2px;bottom:-1px}.session-context{margin:18px 0;display:grid;gap:10px}.session-context>div{display:grid;grid-template-columns:16px 1fr;gap:2px 8px}.session-context i{grid-row:1/3;color:#a3a79e;font-size:.73rem;margin-top:2px}.session-context span{font-size:.64rem;color:var(--muted);text-transform:uppercase;letter-spacing:.06em}.session-context strong{font-size:.76rem;margin-top:2px;overflow:hidden;text-overflow:ellipsis}.session-footer{display:flex;align-items:center;justify-content:space-between;border-top:1px solid var(--line);padding-top:14px}.session-footer small{font-size:.68rem;color:var(--muted)}
